...
import { BaseConsumer, I3Div, RowTextField, RowSwitch, I3Select, GridContainer, GridItem, I3TextField } from "../../importer";
class LabDetail extends BaseConsumer {
    ...
    consumerContent() {
        ...
        return (
            <I3Div margin="xs">
                <RowTextField title="Laboratory name" value={lab.name ? lab.name : ""} onChange={text => this._changeText(lab, "name", text)} />
                <I3Div margin={"md"} >
